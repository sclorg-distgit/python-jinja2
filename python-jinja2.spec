...
Patch0:         %{pkg_name}-fix-CVE-2014-0012.patch
...
%{__python} setup.py install -O1 --skip-build \
	    --root %{buildroot} --install-purelib %{python_sitelib}
%{?scl:"}
...
%changelog
* Wed May 21 2014 Bohuslav Kabrda <bkabrda@redhat.com> - 2.7.2-1
- Rebuilt for devassist09 SCL.
- Update to 2.7.2.
